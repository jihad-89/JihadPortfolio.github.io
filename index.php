  ...
  width: calc(100% - 10px);
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container">
                <!-- LOGO -->
                <a class="navbar-brand logo" href="https://kalvin.netlify.app/index.html">
                    Kalvin
                </a>
        ...
        <section id="home" class="banner" 
				style="background-image: url('https://kalvin.netlify.app/images/background/home-banner-bg.jpg'); 
				height: 670px; 
