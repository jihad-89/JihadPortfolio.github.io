...
<head>
    ...
    <title>Portfolio Jihad Ait Larabi - Développeur Web Junior</title>
...
<nav class="navbar navbar-light" id="nav">
  ...
  <a class="btn btn-light" href="logout.php" role="button">Accueil</a>
    
  </form>
</nav>
    <div class="container-fluid">
        <h4 class="display-3  text-center" style="color:white;font-size:40px;">Bienvenue <?php echo $_SESSION['admin_name']; ?> </h4>
